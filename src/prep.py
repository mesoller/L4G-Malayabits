...
class Prep():
    ...
    def get_service(self, video=None, tag=None, audio=None, guess_title=None, get_services_only=False):
        services = {
            ...
            'National Film Board': 'NFB', 'NFL': 'NFL', 'NFLN': 'NFLN', 'NFL Now': 'NFLN', 'NICK': 'NICK', 'Nickelodeon': 'NICK', 'NOW': 'NOW', 'NOW': 'NOW', 'NRK': 'NRK',
            ...
            'RTE One': 'RTE', 'RUUTU': 'RUUTU', 'SBS': 'SBS', 'Science Channel': 'SCI', 'SESO': 'SESO', 'SeeSo': 'SESO', 'SHMI': 'SHMI', 'Shomi': 'SHMI', 'SKST': 'SKST', 'SkyShowtime': 'SKST', 'SKY': 'SKY', 'SKY': 'SKY',
