...
class BHDTV:
    ...
    async def upload(self, meta, disctype):
        ...
        if (
            meta["anon"] == 0
            and bool(
                str2bool(self.config["TRACKERS"][self.tracker].get("anon", "False"))
            )
            is False
        ):
            anon = 0
        ...
        data = {
            ...
            "url": (
                ...
                if meta["category"] == "TV"
                else f"https://www.imdb.com/title/tt{meta['imdb_id']}"
            ),
            "format": "json",
        }
    ...
    async def get_res_id(self, resolution):
        resolution_id = {"2160p": "4", "1080p": "3", "1080i": "2", "720p": "1"}.get(
            resolution, "10"
        )
