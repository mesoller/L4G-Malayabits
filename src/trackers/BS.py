...
class BS():
    def __init__(self, config):
        ...
        self.tracker = 'BS'
        self.source_flag = 'BS'
        self.upload_url = 'https://bitsexy.cc/api/torrents/upload'
        self.search_url = 'https://bitsexy.cc/api/torrents/filter'
        self.torrent_url = 'https://bitsexy.cc/torrents/'
