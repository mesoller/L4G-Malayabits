...
from src.trackers.SEEDPOOL import SEEDPOOL
...
async def do_the_thing(base_dir):
    ...
    for path in queue:
        ...
        api_trackers = [
            ...
            'OE', 'OTW', 'PSS', 'RF', 'R4E', 'SEEDPOOL', 'SHRI', 'STC', 'STT', 'TIK', 'ULCX', 'UTP', 'YOINK', 'PTT'
        ]
        other_api_trackers = [
        ...
        tracker_class_map = {
            ...
            'R4E': R4E, 'RF': RF, 'RTF': RTF, 'SEEDPOOL': SEEDPOOL, 'SHRI': SHRI, 'SN': SN, 'SPD': SPD, 'STC': STC, 'STT': STT, 'THR': THR,
